...
class Model(torch.nn.Module):
    ...
    def embedding(self, state, locate_tomato, open_mic, place_tomato, close_mic):
    ...
    def forward(self, model_input, locate_tomato, open_mic, place_tomato, close_mic):
        state = model_input.state
        (hx, cx) = model_input.hidden
        x = self.embedding(state, locate_tomato, open_mic, place_tomato, close_mic)
